...
class TestCommImports:
    ...
    def test_import_redis_comm(self) -> None:
        from cognitia.multi_agent.graph_communication_redis import RedisGraphCommunication
        assert RedisGraphCommunication is not None

    def test_import_nats_comm(self) -> None:
        from cognitia.multi_agent.graph_communication_nats import NatsGraphCommunication
