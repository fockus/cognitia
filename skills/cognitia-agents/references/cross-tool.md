...
```
MCP tool: cognitia_memory_get_facts
...
```
```
MCP tool: cognitia_plan_approve
Input: { "plan_id": "plan-1" }
```

### 3. Create Parallel Work Tasks
```
MCP tool: cognitia_team_create_task
...
### 6. Final Summary
```
MCP tool: cognitia_memory_save_summary
