...
class MessageStore(Protocol):
    async def save_message(self, user_id: str, topic_id: str, role: str, content: str, metadata: dict | None = None) -> None: ...
    ...
    async def delete_messages_before(self, user_id: str, topic_id: str, before: datetime) -> int: ...
```
