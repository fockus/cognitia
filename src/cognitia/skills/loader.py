...
1. Cognitia native: skill.yaml + INSTRUCTION.md (two files)
...
class YamlSkillLoader:
    ...
    1. skill.yaml + INSTRUCTION.md  (Cognitia native, higher priority)
    ...
    def load_all(self) -> list[LoadedSkill]:
        ...
        - If skill.yaml exists → load Cognitia native format
    ...
    def _load_from_skill_md(
        ...
        SKILL.md format:
            ...
            mcp-servers:            # Cognitia extension
              - name: server-name
                transport: url
                url: "https://..."
            intents: [keyword1]     # Cognitia extension
            ---
        ...
        # Cognitia extensions (not in standard Claude Code format)
