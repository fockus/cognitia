...
from cognitia.pipeline.budget import BudgetPolicy, BudgetTracker
from cognitia.pipeline.gate import CallbackGate
from cognitia.pipeline.pipeline import Pipeline
from cognitia.pipeline.types import PipelinePhase


class PipelineBuilder:
    """Fluent API to assemble a Pipeline from Cognitia components."""
