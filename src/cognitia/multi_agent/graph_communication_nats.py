...
Each agent inbox is a subject: ``cognitia.inbox.{agent_id}``.
Task threads use: ``cognitia.thread.{task_id}``.
...
class NatsGraphCommunication:
    ...
    def __init__(
        ...
        *,
        ...
        stream_name: str = "COGNITIA_MESSAGES",
    ) -> None:
        self._url = nats_url
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "nats-py package required: pip install 'cognitia[nats]' "
