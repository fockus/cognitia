...
# Entry point group name for Cognitia plugins
EP_GROUP = "cognitia.plugins"

# Sub-groups for typed discovery
EP_GROUPS = {
    PluginType.RUNTIME: "cognitia.runtimes",
    PluginType.MEMORY: "cognitia.memory_providers",
    PluginType.TOOL: "cognitia.tools",
    PluginType.SCORER: "cognitia.scorers",
}
...
class PluginRegistry:
    """Discover and load Cognitia plugins via setuptools entry points."""
