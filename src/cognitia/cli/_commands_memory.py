...
def upsert(
    ...
    from cognitia.mcp._tools_memory import memory_upsert_fact
...
def get_facts(ctx: click.Context, user_id: str, topic_id: str | None) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_memory import memory_get_facts
...
def messages(ctx: click.Context, user_id: str, topic_id: str, limit: int) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_memory import memory_get_messages
