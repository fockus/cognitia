...
from cognitia.cli._app import _print_result, _run_async
...
def register(
    ...
    from cognitia.mcp._tools_team import team_register_agent
...
def agents(ctx: click.Context, role: str | None, status: str | None) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_team import team_list_agents
...
def task(
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_team import team_create_task
...
def claim(ctx: click.Context, assignee_agent_id: str | None) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_team import team_claim_task
...
def tasks(
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_team import team_list_tasks
