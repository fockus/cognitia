...
def create(
    ...
    from cognitia.mcp._tools_plans import plan_create
...
def get_plan(ctx: click.Context, plan_id: str) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_plans import plan_get
...
def list_plans(ctx: click.Context, user_id: str, topic_id: str) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_plans import plan_list
...
def approve(ctx: click.Context, plan_id: str, approved_by: str) -> None:
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_plans import plan_approve
...
def step(
    ...
    from cognitia.mcp._session import StatefulSession
    from cognitia.mcp._tools_plans import plan_update_step
